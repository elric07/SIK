...
Public Class frmDataPelanggan
    ...
    Sub isiGrid()
        ...
        da = New SqlDataAdapter("SELECT * from tbpelanggan", conn)
        ds = New DataSet
    ...
    Sub isiCombo()
        Call bukaDB()
        cmd = New SqlCommand("SELECT kodepelanggan From tbpelanggan", conn)
    ...
    Sub Otomatis()
        modConnection.bukaDB()
        cmd = New SqlCommand("SELECT* FROM tbpelanggan order by kodepelanggan desc", conn)
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Call bukaDB()
        cmd = New SqlCommand("SELECT kodepelanggan,namapelanggan FROM tbpelanggan WHERE kodepelanggan = '" & ComboBox1.Text & "'", conn)
        rd = cmd.ExecuteReader
        rd.Read()
        If rd.HasRows Then
    ...
    Private Sub Button1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            Try
                Call bukaDB()
                cmd = New SqlCommand("SELECT kodepelanggan from tbpelanggan WHERE kodepelanggan = '" & TextBox1.Text & "'", conn)
                rd = cmd.ExecuteReader
                rd.Read()
                If rd.HasRows Then
    ...
    Private Sub DataGridView1_CellDoubleClick1(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        ...
        If e.ColumnIndex = 0 Then
            ...
            Call bukaDB()
            cmd = New SqlCommand("SELECT * from tbpelanggan WHERE kodepelanggan = '" & DataGridView1.Rows(e.RowIndex).Cells(0).Value & "'", conn)
            rd = cmd.ExecuteReader
            If rd.Read Then

...
Public Class frmTambahAdmin
    ...
    Sub isiGrid()
        ...
        da = New SqlDataAdapter("SELECT username,nama,level from tbadmin", conn)
        ds = New DataSet
        da.Fill(ds, "tbadmin")
    ...
    Sub isiCombo()
        Call bukaDB()
        cmd = New SqlCommand("SELECT nama_level From level", conn)
    ...
    Private Sub Button1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            Try
                ...
                TextBox1.Focus()
                Call bukaDB()
                cmd = New SqlCommand("SELECT username from tbadmin WHERE username = '" & TextBox1.Text & "'", conn)
                rd = cmd.ExecuteReader
                rd.Read()
                If rd.HasRows Then
    ...
    Private Sub DataGridView1_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        If e.ColumnIndex = 0 Then
            ...
            TextBox1.Enabled = False
            Call bukaDB()
            cmd = New SqlCommand("SELECT * from tbadmin WHERE username = '" & DataGridView1.Rows(e.RowIndex).Cells(0).Value & "'", conn)
            rd = cmd.ExecuteReader
            If rd.Read Then
